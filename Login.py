...
class LoginFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        btn = ctk.CTkButton(self, text="Đăng nhập", command=self.xu_ly_login, width=250, height=40, corner_radius=20,
                            font=("Arial", 14, "bold"), fg_color="#3b82f6", hover_color="#2563eb", cursor="hand2")
        ...
        if vai_tro_thuc_te:
            if vai_tro_chon == "Admin":
                if vai_tro_thuc_te == "Admin":
                    ...
                    admin_frame = self.controller.get_frame("AdminFrame")
                ...
                home_frame = self.controller.get_frame("HomeFrame")
